...
| ---------------------- | ---------------------------------- | ----------------- |
| **HTML5 / CSS3**       | Pixel-perfect responsive design    | `▰▰▰▰▰▰▰▰▰▰ 100%` |
| **Tailwind CSS**       | Utility-first rapid development    | `▰▰▰▰▰▰▰▰▰▰ 95%`  |
| **JavaScript (ES6+)**  | Advanced concepts & async patterns | `▰▰▰▰▰▰▰▰▰▰ 95%`  |
| **TypeScript**         | Type-safe enterprise development   | `▰▰▰▰▰▰▰▰▰▰ 90%`  |
| **Vue.js / Nuxt.js**   | SSR, Vuex, Composition API         | `▰▰▰▰▰▰▰▰▰▰ 95%`  |
| **React.js / Next.js** | Hooks, Context, App Router         | `▰▰▰▰▰▰▰▰▰▰ 90%`  |
| **Vite / Webpack**     | Build optimization & bundling      | `▰▰▰▰▰▰▰▰▰▰ 95%`  |
...
| Technology        | Expertise                      | Level            |
| ----------------- | ------------------------------ | ---------------- |
| **PHP / Laravel** | MVC, Eloquent, Artisan         | `▰▰▰▰▰▰▰▰▰▰ 95%` |
| **Node.js**       | Express, REST APIs             | `▰▰▰▰▰▰▱▱▱▱ 65%` |
| **NestJS**        | Enterprise architecture        | `▰▰▰▰▰▰▰▱▱▱ 75%` |
| **SQL / MySQL**   | Complex queries & optimization | `▰▰▰▰▰▰▰▰▰▰ 85%` |
| **RESTful APIs**  | Scalable API design            | `▰▰▰▰▰▰▰▰▰▰ 90%` |
...
| **Docker**       | Containerization basics         | `▰▰▰▰▰▰▱▱▱▱ 60%` |
  ...
  <tr>
    <td width="50%">
      ...
      <p align="center">
        ...
        <img src="https://img.shields.io/badge/Alpine.js-8BC0D0?style=flat-square&logo=alpine.js&logoColor=black" alt="Alpine"/>
        <img src="https://img.shields.io/badge/PHP-777BB4?style=flat-square&logo=php&logoColor=white" alt="PHP"/>
        <img src="https://img.shields.io/badge/MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white" alt="MySQL"/>
      </p>
      <p align="center">
        Online programming school with MVC architecture, dynamic content management, and comprehensive admin panel.
      </p>
    </td>
    <td width="50%">
      <h3 align="center">
      ...
      <p align="center">
        Modern corporate showcase with PWA support, SEO optimization, and responsive multilingual design.
      </p>
    </td>
  </tr>
</table>
